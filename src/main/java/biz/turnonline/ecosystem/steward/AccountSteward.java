 ...
 *
 * <p>
 * TurnOnline.biz Ecosystem Account and Resources ownership management
 * </p>
 *
 * <p>
        ...
        extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient
{
    ...
    static
    {
        com.google.api.client.util.Preconditions.checkState(
                ...
                "You are currently running with version %s of google-api-client. " +
                        ...
                        "1.25.0 of the TurnOnline.biz Account Steward library.", com.google.api.client.googleapis.GoogleUtils.VERSION );
    }
    ...
    public class Accounts
    {
        ...
        /**
         * An accessor for creating requests from the Pickup collection.
         *
         * <p>The typical use is:</p>
         * <pre>
         *   {@code AccountSteward steward = new AccountSteward(...);}
         *   {@code AccountSteward.Pickup.List request = steward.pickup().list(parameters ...)}
         * </pre>
         *
         * @return the resource collection
         */
        ...
        /**
         * The "pickup" collection of methods.
         */
        public class Pickup
        {

            /**
             * Create a request for the method "pickup.list".
             * <p>
             * This request holds the parameters needed by the steward server.  After setting any optional
             * parameters, call the {@link List#execute()} method to invoke the remote operation.
             *
            ...
            /**
             * Create a request for the method "pickup.preferred".
             * <p>
             * This request holds the parameters needed by the steward server.  After setting any optional
             * parameters, call the {@link Preferred#execute()} method to invoke the remote operation.
             *
             * @param loginId
             * @param content the {@link biz.turnonline.ecosystem.steward.model.PreferredPickupPoint}
             * @return the request
             */
            public Preferred preferred( java.lang.String loginId,
                                        biz.turnonline.ecosystem.steward.model.PreferredPickupPoint content )
                    throws java.io.IOException
            {
                Preferred result = new Preferred( loginId, content );
                initialize( result );
                return result;
            }

            public class List
                    extends AccountStewardRequest<biz.turnonline.ecosystem.steward.model.PickupPointCollection>
            {

                private static final String REST_PATH = "accounts/{login_id}/pickup-points";
                ...
                {
                    super( AccountSteward.this, "GET", REST_PATH, null, biz.turnonline.ecosystem.steward.model.PickupPointCollection.class );
                    this.loginId = com.google.api.client.util.Preconditions.checkNotNull( loginId, "Required parameter loginId must be specified." );
                }
            ...
            public class Preferred
                    extends AccountStewardRequest<biz.turnonline.ecosystem.steward.model.PickupPoint>
            {

                private static final String REST_PATH = "accounts/{login_id}/pickup-points/preferred";
                 ...
                 * <p>
                 * This request holds the parameters needed by the the steward server.  After setting any optional
                 * parameters, call the {@link Preferred#execute()} method to invoke the remote operation. <p>
                 * {@link
                 * Preferred#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
                 ...
                 * @since 1.13
                 */
                protected Preferred( java.lang.String loginId,
                                     biz.turnonline.ecosystem.steward.model.PreferredPickupPoint content )
                {
                    super( AccountSteward.this, "PUT", REST_PATH, content, biz.turnonline.ecosystem.steward.model.PickupPoint.class );
                    this.loginId = com.google.api.client.util.Preconditions.checkNotNull( loginId, "Required parameter loginId must be specified." );
                }

                @Override
                public Preferred setAlt( java.lang.String alt )
                {
                    return ( Preferred ) super.setAlt( alt );
                }

                @Override
                public Preferred setFields( java.lang.String fields )
                {
                    return ( Preferred ) super.setFields( fields );
                }

                @Override
                public Preferred setKey( java.lang.String key )
                {
                    return ( Preferred ) super.setKey( key );
                }

                @Override
                public Preferred setOauthToken( java.lang.String oauthToken )
                {
                    return ( Preferred ) super.setOauthToken( oauthToken );
                }

                @Override
                public Preferred setPrettyPrint( java.lang.Boolean prettyPrint )
                {
                    return ( Preferred ) super.setPrettyPrint( prettyPrint );
                }

                @Override
                public Preferred setQuotaUser( java.lang.String quotaUser )
                {
                    return ( Preferred ) super.setQuotaUser( quotaUser );
                }

                @Override
                public Preferred setUserIp( java.lang.String userIp )
                {
                    return ( Preferred ) super.setUserIp( userIp );
                }
                ...
                public Preferred setLoginId( java.lang.String loginId )
                {
                    this.loginId = loginId;
                    return this;
                }
                ...
                @Override
                public Preferred set( String parameterName, Object value )
                {
                    return ( Preferred ) super.set( parameterName, value );
                }
            }
        ...
        public class Sub
        {
             ...
             * @return the request
             */
            public Delete delete( java.lang.String loginId, java.lang.String deputyEmail ) throws java.io.IOException
            {
                Delete result = new Delete( loginId, deputyEmail );
                initialize( result );
                return result;
            }
             ...
             * @return the request
             */
            public Get get( java.lang.String loginId, java.lang.String deputyEmail ) throws java.io.IOException
            {
                Get result = new Get( loginId, deputyEmail );
                initialize( result );
                return result;
            }
             ...
             *
             * @param loginId
             * @param content the {@link biz.turnonline.ecosystem.steward.model.DeputyAccount}
             * @return the request
             */
            public Insert insert( java.lang.String loginId,
                                  biz.turnonline.ecosystem.steward.model.DeputyAccount content )
                    throws java.io.IOException
            {
             ...
             */
            public Update update( java.lang.String loginId,
                                  java.lang.String deputyEmail,
                                  biz.turnonline.ecosystem.steward.model.DeputyAccount content )
                    throws java.io.IOException
            {
                Update result = new Update( loginId, deputyEmail, content );
                initialize( result );
                return result;
            }
                    ...
                    extends AccountStewardRequest<Void>
            {
                ...
                private java.lang.String deputyEmail;
                 ...
                 * @since 1.13
                 */
                protected Delete( java.lang.String loginId, java.lang.String deputyEmail )
                {
                    super( AccountSteward.this, "DELETE", REST_PATH, null, Void.class );
                    this.loginId = com.google.api.client.util.Preconditions.checkNotNull( loginId, "Required parameter loginId must be specified." );
                    this.deputyEmail = com.google.api.client.util.Preconditions.checkNotNull( deputyEmail, "Required parameter deputyEmail must be specified." );
                }
                 ...
                 *
                 */
                public java.lang.String getDeputyEmail()
                {
                    return deputyEmail;
                }

                public Delete setDeputyEmail( java.lang.String deputyEmail )
                {
                    ...
                    extends AccountStewardRequest<biz.turnonline.ecosystem.steward.model.DeputyAccount>
            {
                 ...
                 * @since 1.13
                 */
                protected Get( java.lang.String loginId, java.lang.String deputyEmail )
                {
                    super( AccountSteward.this, "GET", REST_PATH, null, biz.turnonline.ecosystem.steward.model.DeputyAccount.class );
                    this.loginId = com.google.api.client.util.Preconditions.checkNotNull( loginId, "Required parameter loginId must be specified." );
                    this.deputyEmail = com.google.api.client.util.Preconditions.checkNotNull( deputyEmail, "Required parameter deputyEmail must be specified." );
                }
                ...
                public Get setDeputyEmail( java.lang.String deputyEmail )
                {
                    this.deputyEmail = deputyEmail;
                    return this;
                }
            ...
            public class List
                    extends AccountStewardRequest<biz.turnonline.ecosystem.steward.model.DeputyAccountCollection>
            {
                ...
                protected List( java.lang.String loginId )
                {
                    super( AccountSteward.this, "GET", REST_PATH, null, biz.turnonline.ecosystem.steward.model.DeputyAccountCollection.class );
                    this.loginId = com.google.api.client.util.Preconditions.checkNotNull( loginId, "Required parameter loginId must be specified." );
                }
                    ...
                    extends AccountStewardRequest<biz.turnonline.ecosystem.steward.model.Account>
            {
                ...
                public Update setDeputyEmail( java.lang.String deputyEmail )
                {
                    this.deputyEmail = deputyEmail;
                    return this;
                }
    ...
    public class Contacts
    {
        ...
        /**
         * Create a request for the method "contacts.add".
         * <p>
         * This request holds the parameters needed by the steward server.  After setting any optional
         ...
         * @return the request
         */
        public Add add( java.lang.String loginId, java.lang.Long accountId ) throws java.io.IOException
        {
            Add result = new Add( loginId, accountId );
            initialize( result );
            return result;
        }
                ...
                extends AccountStewardRequest<biz.turnonline.ecosystem.steward.model.ContactCard>
        {
            ...
            private static final String REST_PATH = "accounts/{login_id}/accounts/{account_id}/contacts";
             ...
             * @since 1.13
             */
            protected Add( java.lang.String loginId, java.lang.Long accountId )
            {
                super( AccountSteward.this, "PUT", REST_PATH, null, biz.turnonline.ecosystem.steward.model.ContactCard.class );
                this.loginId = com.google.api.client.util.Preconditions.checkNotNull( loginId, "Required parameter loginId must be specified." );
            ...
            public Add setLoginId( java.lang.String loginId )
            {
                this.loginId = loginId;
                return this;
            }
            ...
            public Add setAccountId( java.lang.Long accountId )
            {
