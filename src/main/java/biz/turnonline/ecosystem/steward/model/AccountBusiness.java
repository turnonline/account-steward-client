...
{
    private static final long serialVersionUID = -6612260509763159333L;
     ...
     */
    @com.google.api.client.util.Key
    private java.util.Map<String, java.lang.String> why;
     ...
     */
    public AccountBusiness setMarketplace( java.lang.Boolean marketplace )
    {
     ...
     * @return value or {@code null} for none
     */
    public java.util.Map<String, java.lang.String> getWhy()
    {
        return why;
    }

    /**
     * @param why why or {@code null} for none
     */
    public AccountBusiness setWhy( java.util.Map<String, java.lang.String> why )
    {
        this.why = why;
        return this;
    }
