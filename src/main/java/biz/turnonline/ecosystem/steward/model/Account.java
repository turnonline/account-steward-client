...
{
    private static final long serialVersionUID = -2380052433441901252L;
     ...
     */
    @com.google.api.client.util.Key
    private java.util.Map<String, java.lang.String> linkedAudiences;
     ...
     * @return value or {@code null} for none
     */
    public java.util.Map<String, java.lang.String> getLinkedAudiences()
    {
        return linkedAudiences;
    }

    /**
     * @param linkedAudiences linkedAudiences or {@code null} for none
     */
    public Account setLinkedAudiences( java.util.Map<String, java.lang.String> linkedAudiences )
    {
     ...
     */
    public Account setPayment( PaymentConfig payment )
    {
