        ...
        extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient
{
     ...
     * <pre>
     *   {@code AccountManagement accountManagement = new AccountManagement(...);}
     *   {@code AccountManagement.Countries.List request = accountManagement.countries().list(parameters ...)}
     * </pre>
     *
     * @return the resource collection
     */
     ...
     * <pre>
     *   {@code AccountManagement accountManagement = new AccountManagement(...);}
     *   {@code AccountManagement.Legalforms.List request = accountManagement.legalforms().list(parameters ...)}
     * </pre>
     *
     * @return the resource collection
     */
    ...
    public class Accounts
    {
         ...
         * @return the request
         */
        public Update update( java.lang.String loginEmail, biz.turnonline.ecosystem.accountManagement.model.Account content )
                throws java.io.IOException
        {
         ...
         * <pre>
         *   {@code AccountManagement accountManagement = new AccountManagement(...);}
         *   {@code AccountManagement.Sub.List request = accountManagement.sub().list(parameters ...)}
         * </pre>
         *
         * @return the resource collection
         */
                ...
                extends AccountManagementRequest<biz.turnonline.ecosystem.accountManagement.model.Account>
        {
             ...
             * @since 1.13
             */
            protected Update( java.lang.String loginEmail, biz.turnonline.ecosystem.accountManagement.model.Account content )
            {
        ...
        public class Sub
        {
             ...
             *
             * @param loginEmail
             * @param content    the {@link biz.turnonline.ecosystem.accountManagement.model.SubAccount}
             * @return the request
             */
            public Insert insert( java.lang.String loginEmail, biz.turnonline.ecosystem.accountManagement.model.SubAccount content )
                    throws java.io.IOException
            {
             ...
             * @return the request
             */
            public Update update( java.lang.String loginEmail, java.lang.String subEmail, biz.turnonline.ecosystem.accountManagement.model.SubAccount content )
                    throws java.io.IOException
            {
            ...
            public class Get
                    extends AccountManagementRequest<biz.turnonline.ecosystem.accountManagement.model.SubAccount>
            {
                ...
                {
                    super( AccountManagement.this, "POST", REST_PATH, null, biz.turnonline.ecosystem.accountManagement.model.SubAccount.class );
                    this.loginEmail = com.google.api.client.util.Preconditions.checkNotNull( loginEmail, "Required parameter loginEmail must be specified." );
                    this.subEmail = com.google.api.client.util.Preconditions.checkNotNull( subEmail, "Required parameter subEmail must be specified." );
                }
                    ...
                    extends AccountManagementRequest<biz.turnonline.ecosystem.accountManagement.model.Account>
            {
                 ...
                 * @since 1.13
                 */
                protected Insert( java.lang.String loginEmail, biz.turnonline.ecosystem.accountManagement.model.SubAccount content )
                {
                    super( AccountManagement.this, "POST", REST_PATH, content, biz.turnonline.ecosystem.accountManagement.model.Account.class );
                    this.loginEmail = com.google.api.client.util.Preconditions.checkNotNull( loginEmail, "Required parameter loginEmail must be specified." );
                }
            ...
            public class List
                    extends AccountManagementRequest<biz.turnonline.ecosystem.accountManagement.model.SubAccountCollection>
            {
                ...
                {
                    super( AccountManagement.this, "GET", REST_PATH, null, biz.turnonline.ecosystem.accountManagement.model.SubAccountCollection.class );
                    this.loginEmail = com.google.api.client.util.Preconditions.checkNotNull( loginEmail, "Required parameter loginEmail must be specified." );
                }
                    ...
                    extends AccountManagementRequest<biz.turnonline.ecosystem.accountManagement.model.Account>
            {
                 ...
                 * @since 1.13
                 */
                protected Update( java.lang.String loginEmail, java.lang.String subEmail, biz.turnonline.ecosystem.accountManagement.model.SubAccount content )
                {
                    super( AccountManagement.this, "PUT", REST_PATH, content, biz.turnonline.ecosystem.accountManagement.model.Account.class );
                    this.loginEmail = com.google.api.client.util.Preconditions.checkNotNull( loginEmail, "Required parameter loginEmail must be specified." );
                    this.subEmail = com.google.api.client.util.Preconditions.checkNotNull( subEmail, "Required parameter subEmail must be specified." );
    ...
    public class Countries
    {
        ...
        public class Get
                extends AccountManagementRequest<biz.turnonline.ecosystem.accountManagement.model.Country>
        {
            ...
            {
                super( AccountManagement.this, "GET", REST_PATH, null, biz.turnonline.ecosystem.accountManagement.model.Country.class );
        ...
        public class List
                extends AccountManagementRequest<biz.turnonline.ecosystem.accountManagement.model.CountryCollection>
        {
            ...
            protected List()
            {
                super( AccountManagement.this, "GET", REST_PATH, null, biz.turnonline.ecosystem.accountManagement.model.CountryCollection.class );
            }
    ...
    public class Legalforms
    {
        ...
        public class Get
                extends AccountManagementRequest<biz.turnonline.ecosystem.accountManagement.model.LegalForm>
        {
            ...
            protected Get( java.lang.String code )
            {
                super( AccountManagement.this, "GET", REST_PATH, null, biz.turnonline.ecosystem.accountManagement.model.LegalForm.class );
                this.code = com.google.api.client.util.Preconditions.checkNotNull( code, "Required parameter code must be specified." );
            }
        ...
        public class List
                extends AccountManagementRequest<biz.turnonline.ecosystem.accountManagement.model.LegalFormCollection>
        {
            ...
            protected List()
            {
                super( AccountManagement.this, "GET", REST_PATH, null, biz.turnonline.ecosystem.accountManagement.model.LegalFormCollection.class );
            }
